...
#define ROBOEYES_N 1 // north, top center
#define ROBOEYES_NE 2 // north-east, top right
#define ROBOEYES_E 3 // east, middle right
#define ROBOEYES_SE 4 // south-east, bottom right
#define ROBOEYES_S 5 // south, bottom center
#define ROBOEYES_SW 6 // south-west, bottom left
#define ROBOEYES_W 7 // west, middle left
#define ROBOEYES_NW 8 // north-west, top left 
