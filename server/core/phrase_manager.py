...
class PhraseManager:
    def __init__(self, tts_engine: TTSEngine):
        ...
        self.phrases = {
            ...
            "thinking": [
                "Dạ, để cháu nghĩ chút nha ngoại.", "Ngoại đợi cháu chút.", "Cháu đang tìm câu trả lời.", 
                "Cháu xem thử nha.", "Dạ, để cháu kiểm tra.", "Cháu đang suy nghĩ.", 
                "Cho cháu vài giây nha ngoại.", "Cháu xử lý ngay đây.", "Đợi cháu một lát nha ngoại.", 
                "Dạ, gần xong rồi.", "Để cháu xem nào."
            ],
            "goodbye": [
